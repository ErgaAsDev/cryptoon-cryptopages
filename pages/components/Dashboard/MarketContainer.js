                ...
                <div className="card shining-card">
                  <div className="card-body">
                    <img
                      ...
                      alt="img60"
                    />
                    <span className="fs-5 me-2">BTC/USDT</span>
                    <svg
                      width="36"
                      height="35"
                      viewBox="0 0 36 35"
                    ...
                    <div className="pt-3">
                      <h4 className="counter">$34.850,10</h4>
                      <div className="pt-3">
                        <small>+ 0.8%</small>
                      </div>
                    </div>
                ...
                <div className="card shining-card">
                  <div className="card-body">
                    <img
                      ...
                      alt="img60"
                    />
                    <span className="fs-5 me-2">ETH/USDT</span>
                    <svg
                      width="36"
                      height="35"
                      viewBox="0 0 36 35"
                    ...
                    <div className="progress-detail pt-3">
                      <h4 className="counter">$2,138.87</h4>
                      <div className="pt-3">
                        <small>+ 0.8%</small>
                      </div>
                    </div>
                ...
                <div className="card shining-card">
                  <div className="card-body">
                    <img
                      ...
                      alt="img60"
                    />
                    <span className="fs-5 me-2">LTC/USDT</span>
                    <svg
                      width="36"
                      height="35"
                      viewBox="0 0 36 35"
                  ...
                  <div className="card-body text-center">
                    <div className="row">
                      <div className="col-md-6">
                        <div className="card bg-soft-secondary align-items-center shadow-none mb-lg-0 pt-4">
                          <div className="avatar bg-secondary p-2 mb-2">
                            <svg
                              width="50"
                              viewBox="0 0 70 70"
                              fill="none"
                          ...
                          <h6 className="pt-4">This Week</h6>
                          <div className="pt-4">
                      ...
                      <div className="col-md-6">
                        <div className="card bg-soft-secondary align-items-center pt-4 shadow-none mb-0">
                          <div className="avatar bg-secondary p-2 mb-2">
                            <svg
                              width="50"
                              viewBox="0 0 70 70"
                            ...
                            >
                              <path
                                d="M7 41V16C7 15.4477 7.44772 15 8 15H35"
                                stroke="white"
                                stroke-linecap="round"
                              />
                              <path
                          ...
                          <h6 className="pt-4">This Month</h6>
                          <div className="pt-4">
                            <h5 className="counter">
                              $3.45K
                              <span>
            ...
            <div className="card card-block card-stretch custom-scroll">
              <div className="card-header d-flex flex-wrap justify-content-between align-items-center">
                ...
                >
                  ...
                  <label className="btn btn-sm btn-secondary" for="btncheck2">
                    Weekly
                  </label>
