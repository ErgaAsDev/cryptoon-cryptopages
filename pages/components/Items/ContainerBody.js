  ...
  return (
    ...
    >
      ...
      <div className="d-flex flex-column mt-5 gap-3" id="crypto-column">
        <div className="d-flex flex-row" id="column-1">
          <p>Bitcoin</p>
          <p className="text-primary">BTC</p>
          <p>$56,290.30</p>
          <p className="text-success">+1.68%</p>
          <Image alt="images" src="/images/small-graph-1.png" width={100} height={30} />
          <Link href="/">
            <p>Trade Now</p>
          </Link>
        </div>
        <div className="d-flex flex-row gap-5" id="column-2">
          ...
          <Image alt="images" src="/images/small-graph-2.png" width={100} height={30} />
          <Link href="/">
            <p>Trade Now</p>
          </Link>
        </div>
        <div className="d-flex flex-row gap-5" id="column-3">
          ...
          <Image alt="images" src="/images/small-graph-3.png" width={100} height={30} />
          <Link href="/">
            <p>Trade Now</p>
          </Link>
        </div>
        <div className="d-flex flex-row gap-5" id="column-4">
          ...
          <Image alt="images" src="/images/small-graph-4.png" width={100} height={30} />
          <Link href="/">
            <p>Trade Now</p>
          </Link>
        </div>
        <div className="d-flex flex-row gap-5" id="column-5">
          ...
          <Image alt="images" src="/images/small-graph-5.png" width={100} height={30} />
          <Link href="/">
            <p>Trade Now</p>
          </Link>
        </div>
      </div>
      <Image alt="images" src="/images/BrandCompany.png" width={1400} height={140} className="mt-5" id="brand-company"/>
